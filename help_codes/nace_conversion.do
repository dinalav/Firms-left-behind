...
/* for the generation of conversion tables
see \codes JEEA res\help_codes */

global codes = "$path\codes JEEA res"
global help = "$path\data JEEA res\help files"
global temp = "$path\data JEEA res\temp"

cd "$path\data JEEA res\help files"
